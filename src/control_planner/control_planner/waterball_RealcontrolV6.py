...
from waterballControlBasisV6 import WaterballSubscriber,Waterball_Psi_d_Generator,Waterball_50,angle_diff
...
def main_loop():
    ...
    try: 
        while not rospy.is_shutdown() and (time_clock<=30000): # 5mins stop automatically.
            ...
            Ball.Basis.publish_cmd_vel(vx_d, angular_v_d)
            ...
            if loop_counter > 100:
                print("\n vx_d:%f, angular_v_d:%f,\n psi_d:%f, psi:%f"%(vx_d,angular_v_d,psi_d,Ball.psi))
...
if __name__ == "__main__":
    rospy.init_node("waterball_RealcontrolV6")
    # Basic class init

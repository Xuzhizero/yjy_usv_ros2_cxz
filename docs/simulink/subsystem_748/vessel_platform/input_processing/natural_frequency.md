...
| $G_{33}/M_{33}$ | Divide2输出 | 刚度/质量比 | 中间变量 |
| $G_{44}/M_{44}$ | Divide3输出 | 刚度/惯量比 | 中间变量 |
| $G_{55}/M_{55}$ | Divide4输出 | 刚度/惯量比 | 中间变量 |
| $[\omega_3,\omega_4,\omega_5]$ | Sqrt输出 (名称=w3 w4 w5) | $\sqrt{[G_{ii}/M_{ii}]}$ | 固有频率向量 |
